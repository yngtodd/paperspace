...
class VGG(nn.Module):
    def __init__(self, kernel1=3, kernel2=3, kernel3=3, kernel4=3, kernel5=3,
                 kernel6=4, kernel7=4, kernel8=3, kernel9=3, kernel10=3,
        ...
        self.block1 = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=self.kernel1),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(64, 128, self.kernel2),
            nn.BatchNorm2d(128),
            nn.ReLU(),
